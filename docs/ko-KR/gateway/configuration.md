...
- 공식/TestFlight iOS 빌드용 relay-backed push는 `gateway.push.apns.relay.baseUrl`과 `timeoutMs`로 구성합니다.
- `config.apply` 예시의 WhatsApp direct 세션 키 형식은 `agent:main:whatsapp:direct:+15555550123`입니다.
