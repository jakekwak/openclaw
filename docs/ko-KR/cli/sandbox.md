...
- [Sandbox Documentation](/ko-KR/gateway/sandboxing)
- [Agent Configuration](/ko-KR/concepts/agent-workspace)
- [Doctor Command](/ko-KR/gateway/doctor) - Check sandbox setup
