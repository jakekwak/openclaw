...
- **[Node 24 권장](/ko-KR/install/node)** (호환성을 위해 Node 22 LTS, 현재 `22.16+`도 계속 지원되며, [설치 방법](#install-methods) 스크립트는 없을 경우 Node 24를 설치합니다)
...
<AccordionGroup>
  ...
  <Accordion title="npm / pnpm" icon="package">
    Node를 직접 관리한다면 Node 24를 권장합니다. OpenClaw는 호환성을 위해 Node 22 LTS(`22.16+`)도 계속 지원합니다:
